...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03/10/2023 às 22:04
...
INSERT INTO `class` (`id_class`, `id_curso`, `id_aluno`, `id_teacher`) VALUES
(3, 1, NULL, NULL),
(4, 2, NULL, NULL),
(5, 3, NULL, NULL),
(6, 4, NULL, NULL),
...
(2, '987654321', 'teacher@teacher', 'teacher', 'professor', 'prof', 'rua Coruja 15', '2023-09-02', 2, NULL, 'activo'),
(3, '147852369', 'alumnos@alumnos', 'alumnos', 'alunos', 'alunos', 'corujinha', '2023-08-10', 2, NULL, 'activo'),
(8, '807507837-3', 'civons0@unblog.fr', 'iZ7\'ot8WPR?x\'C)', 'Clemente Ivons', 'civons0', 'PO Box 67841', NULL, 2, NULL, 'activo'),
(9, '041855264-9', 'emarven1@ucoz.ru', 'dL3}2w1#Y`F', 'Ermengarde Marven', 'emarven1', '12th Floor', NULL, 2, NULL, 'activo'),
(10, '841576081-7', 'bpendall2@cnn.com', 'mS5%n&pr6G9X*(', 'Beatriz Pendall', 'bpendall2', 'Suite 56', NULL, 2, NULL, 'activo'),
(11, '477335053-9', 'lmccoy3@salon.com', 'tX4|6Pf`aNS=68', 'Lynnelle McCoy', 'lmccoy3', 'Apt 1120', NULL, 2, NULL, 'activo'),
(12, '540530102-7', 'abeardsworth4@newyorker.com', 'wC0}hl4v_fRZqK1', 'Anastassia Beardsworth', 'abeardsworth4', '6th Floor', NULL, 2, NULL, 'activo'),
(13, '953608108-3', 'tveljes5@techcrunch.com', 'dV4/$h)jmr', 'Thorn Veljes', 'tveljes5', 'Room 101', NULL, 2, NULL, 'activo'),
(14, '204486163-1', 'pungerer6@sina.com.cn', 'gH73|4G}CO7S', 'Phelia Ungerer', 'pungerer6', 'PO Box 47979', NULL, 2, NULL, 'activo'),
(15, '653763062-2', 'afernihough7@ed.gov', 'bK6$uSktptsO?)A@', 'Anabella Fernihough', 'afernihough7', '7th Floor', NULL, 2, NULL, 'activo'),
(16, '783956280-9', 'jdrynan8@deviantart.com', 'xY8DOf1', 'Jehanna Drynan', 'jdrynan8', 'Apt 296', NULL, 3, NULL, 'activo'),
(17, '419261807-9', 'smorrant9@archive.org', 'lY0)<SEQB', 'Sigrid Morrant', 'smorrant9', 'Suite 82', NULL, 3, NULL, 'activo'),
(18, '821351819-5', 'troskillya@answers.com', 'rR1|~\"XB<}', 'Tracie Roskilly', 'troskillya', 'Suite 91', NULL, 3, NULL, 'activo'),
(19, '423532999-5', 'alangrickb@examiner.com', 'wY6>\"Nf}{4H1\"', 'Alvin Langrick', 'alangrickb', 'Suite 26', NULL, 3, NULL, 'activo'),
(20, '544606708-8', 'bpechac@lycos.com', 'wH7*=s(8', 'Bianca Pecha', 'bpechac', 'PO Box 8776', NULL, 3, NULL, 'activo'),
(21, '158619506-9', 'tmoffettd@wisc.edu', 'rB1)|lm3S*Ub>)A', 'Tedd Moffett', 'tmoffettd', 'Apt 1101', NULL, 3, NULL, 'activo'),
(22, '653408355-8', 'urudolfere@amazonaws.com', 'uX7/bz+aj', 'Ursala Rudolfer', 'urudolfere', 'Apt 1025', NULL, 3, NULL, 'activo'),
...
(59, NULL, 'joshuacardoso97@gmail.com', '', 'JOSHUA PEDRO CARDOSO', 'josh', 'Casa', NULL, NULL, NULL, 'activo'),
(61, NULL, 'joshu@gmail.com', '', 'JCARDOSO', 'josh', 'Casa', NULL, NULL, NULL, 'activo'),
(62, NULL, 'lidialanasol@gmail.com', '', 'Lídia Lana Ribeiro Sol', '', 'Casa', NULL, NULL, NULL, 'activo'),
(64, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, 'activo'),
(65, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'activo'),
(66, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 'activo');
...
--
ALTER TABLE `class`
  ADD CONSTRAINT `class_ibfk_1` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_curso`),
  ADD CONSTRAINT `class_ibfk_2` FOREIGN KEY (`id_aluno`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `class_ibfk_3` FOREIGN KEY (`id_teacher`) REFERENCES `usuario` (`id_usuario`);
